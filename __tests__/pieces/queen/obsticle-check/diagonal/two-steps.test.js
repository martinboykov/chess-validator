...
describe('queen', () => {
  ...
  describe('obsticle check', () => {
    ...
    describe('two steps distance', () => { // checking if positions 1 is obstructed
      it('should return "false" if queen start pos is "e4" and end pos is "g6" without piece at end', () => { // eslint-disable-line max-len
        const start = 'e4';
        const end = 'g6';
      ...
      it('should return "true" if queen start pos is "e4" and end pos is "g6" with same color piece at mid', () => { // eslint-disable-line max-len
        const start = 'e4';
        const mid = 'f5';
        const end = 'g6';
        const board = new Board();
      ...
      it('should return "true" if queen start pos is "e4" and end pos is "g6" with opposite color piece at mid', () => { // eslint-disable-line max-len
        const start = 'e4';
        const mid = 'f5';
        const end = 'g6';
        const board = new Board();
